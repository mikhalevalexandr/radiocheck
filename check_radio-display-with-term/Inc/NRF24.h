...
#define LED_ON HAL_GPIO_WritePin(LD4_GPIO_Port, LD4_Pin, GPIO_PIN_RESET)

#define LED_OFF HAL_GPIO_WritePin(LD4_GPIO_Port, LD4_Pin, GPIO_PIN_SET)

#define LED_TGL HAL_GPIO_TogglePin(LD4_GPIO_Port, LD4_Pin)

#define LED2_ON HAL_GPIO_WritePin(LD3_GPIO_Port, LD3_Pin, GPIO_PIN_RESET)

#define LED2_OFF HAL_GPIO_WritePin(LD3_GPIO_Port, LD3_Pin, GPIO_PIN_SET)
